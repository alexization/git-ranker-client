...
- Cross-link: [frontend-a11y](../frontend-a11y/SKILL.md) covers WCAG criteria and pattern libraries
...
- Skills: [react-performance](../react-performance/SKILL.md) for the Vercel-derived performance ruleset, [frontend-a11y](../frontend-a11y/SKILL.md) for accessibility, [nextjs-turbopack](../nextjs-turbopack/SKILL.md) for Next.js/Turbopack
