...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        // Base styles
        "fixed z-50 grid gap-4 border-2 bg-background shadow-2xl duration-200",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",

        // Mobile: bottom sheet style with safe area
        "inset-x-4 bottom-4 w-auto rounded-3xl",
        ...
        "sm:inset-auto sm:left-[50%] sm:top-[50%] sm:w-full sm:max-w-lg",
        "sm:translate-x-[-50%] sm:translate-y-[-50%]",
        "sm:max-h-[85dvh] sm:pb-6 sm:p-8 sm:gap-6",
